...
class __TwigTemplate_415dfcc495cdc0dbf81a119f5398e285bd26e488495770a662dd47cf9ef4053b extends craft\web\twig\Template
{
    private $source;
...
<div class=\"";
    ...
    ";
        ...
        if (((isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new Twig_Error_Runtime('Variable "label" does not exist.', 21, $this->source); })()) || (isset($context["instructions"]) || array_key_exists("instructions", $context) ? $context["instructions"] : (function () { throw new Twig_Error_Runtime('Variable "instructions" does not exist.', 21, $this->source); })()))) {
            ...
            if ((isset($context["instructions"]) || array_key_exists("instructions", $context) ? $context["instructions"] : (function () { throw new Twig_Error_Runtime('Variable "instructions" does not exist.', 29, $this->source); })())) {
                ...
                echo $this->extensions['craft\web\twig\Extension']->replaceFilter(call_user_func_array($this->env->getFilter('md')->getCallable(), array((isset($context["instructions"]) || array_key_exists("instructions", $context) ? $context["instructions"] : (function () { throw new Twig_Error_Runtime('Variable "instructions" does not exist.', 30, $this->source); })()))), "/&amp;(\\w+);/", "&\$1;");
                echo "</div>
            ";
            }
            // line 32
    ...
    ";
        ...
        if ((isset($context["warning"]) || array_key_exists("warning", $context) ? $context["warning"] : (function () { throw new Twig_Error_Runtime('Variable "warning" does not exist.', 37, $this->source); })())) {
            ...
            echo $this->extensions['craft\web\twig\Extension']->replaceFilter(call_user_func_array($this->env->getFilter('md')->getCallable(), array((isset($context["warning"]) || array_key_exists("warning", $context) ? $context["warning"] : (function () { throw new Twig_Error_Runtime('Variable "warning" does not exist.', 38, $this->source); })()), "gfm", true)), "/&amp;(\\w+);/", "&\$1;");
            echo "</p>
    ";
        }
        // line 40

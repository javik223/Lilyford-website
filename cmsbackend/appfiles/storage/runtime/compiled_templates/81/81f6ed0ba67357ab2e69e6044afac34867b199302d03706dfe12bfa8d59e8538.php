...
class __TwigTemplate_bdc22397800a0e5b9714715a0fbc01f07c9e360512e0354dc7d81aec04d32e5c extends craft\web\twig\Template
{
    private $source;
...
($context["view"] ?? null), "registerJsFile", array(0 => "/assets/js/jquery/jquery.min.js"), "method");
        // line 5
        craft\helpers\Template::attribute($this->env, $this->getSourceContext(),         // line 6
($context["view"] ?? null), "registerJsFile", array(0 => "https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.js"), "method");
        // line 7
        craft\helpers\Template::attribute($this->env, $this->getSourceContext(),         // line 8
($context["view"] ?? null), "registerJsFile", array(0 => "/assets/js/app.js"), "method");
    }
